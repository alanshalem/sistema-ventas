...
export async function MostrarAlmacenXSucursal(
  p: MostrarAlmacenXSucursalParams
...
export async function MostrarAlmacenesXEmpresa(
  p: MostrarAlmacenesXEmpresaParams
...
export async function MostrarAlmacenesXSucursal(
  p: MostrarAlmacenesXSucursalParams
): Promise<Almacen[] | null> {
